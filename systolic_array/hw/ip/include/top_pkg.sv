...
parameter SYSTOLIC_MODULE_HEIGHT = TRANSFORMATION_ROWS;
parameter SYSTOLIC_MODULE_COUNT = 4;
parameter CORE_COUNT = 1;
parameter HIGH_PRECISION_SYSTOLIC_MODULE_COUNT = 2;
...
// Accumulator width
parameter HIGH_PRECISION_ACCUMULATOR_WIDTH = 32;
parameter LOW_PRECISION_ACCUMULATOR_WIDTH = 16;
